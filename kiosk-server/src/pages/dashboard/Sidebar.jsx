  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-40 p-2 bg-slate-800 rounded-lg text-slate-300 hover:text-white transition-colors"
      >
      ...
      {mobileOpen && (
        <div className="md:hidden fixed inset-0 z-50">
          <div
            ...
            onClick={() => setMobileOpen(false)}
          />
          <div className="absolute left-0 top-0 bottom-0 w-60 bg-slate-800">
            {sidebarContent}
          </div>
        </div>
      )}
      ...
      {/* Desktop sidebar */}
      <div className="hidden md:block w-60 bg-slate-800 border-r border-slate-700 flex-shrink-0">
        {sidebarContent}
      </div>
    </>
  );
